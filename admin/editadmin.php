...
<form action="" method="post">
 ...
 ?>
        <div class="control-group">
            ...
            <input type="checkbox" name="quyen[]" value="2" <?php echo (in_array('2', $quyen)?'checked':'') ?>>Giao viên
            <input type="checkbox" name="quyen[]" value="3" <?php echo (in_array('3', $quyen)?'checked':'') ?>>Thanh tra
        </div>

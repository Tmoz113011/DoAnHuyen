                ...
                <div class="title">
                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8"><input type="number" min="0" value="15" disabled
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="hd" checked disabled>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-5"><input type="text" class="disabled form-control"
                                                             value="Nguyen Văn A" disabled></div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-5"><input type="text" class="form-control disabled"
                                                             value="Nguyen Văn A" disabled></div>
                                <div class="col-sm-2">Xếp loại:</div>
                                <div class="col-sm-3">
                                    <select name="" id="" class="form-control" disabled>

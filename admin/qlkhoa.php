...
<table class="table table-hover">
	...
	<tbody>
		<?php 
			...
			<td><a href="javascript:void(0)" onclick="edit('<?php echo $value['id'] ?>','<?php echo $value['tenkhoa'] ?>')" title="">Sửa</a> | <a href="index.php?page=xoakhoa&id=<?php echo $value['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')" title="">Xóa</a></td>
		</tr>
			<?php
			}
